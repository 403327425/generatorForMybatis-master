...
//public static  long UPLOAD_PRESS=0;
...
//   try {
//    myFtp.connect("42.51.7.154", 21, "dgtsbj_wx", "tSQ3nwSD8SwBMSHm");
...
//    System.out.println(myFtp.upload(new File("c://1.mp4"),"articlefile/22.mp4"));
//    //System.out.println(myFtp.download("/1.mp4", "/22.mp4"));
//    myFtp.disconnect();
//   } catch (IOException e) {
