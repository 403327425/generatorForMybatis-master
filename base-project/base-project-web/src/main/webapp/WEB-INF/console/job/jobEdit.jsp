	...
	<div class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="jobName" lay-verify="jobName" placeholder="请输入职位名称" autocomplete="off" class="layui-input" value="${job.jobName }">
		  	</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
        		<select name="jobParentId" lay-search="">
          			...
          			<c:forEach var="jobs" items="${jobList }">
          				<option value="${jobs.jobId }" <c:if test="${job.jobParentId eq jobs.jobId }">selected='selected'</c:if>>${jobs.jobName }</option>
          			</c:forEach>
        		</select>
      		</div>
    	</div>
